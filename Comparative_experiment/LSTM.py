...
class LSTMRegressor(nn.Module):
    ...
    def forward(self, x):
        ...
        out, (hn, cn) = self.lstm(x)  # out: [batch, seq, hidden]
...
def main():
    ...
    # data_file = '../regression_task_data/original_regression_dataset1.xlsx'  # Please ensure the data path is correct
    # data_file = '../regression_task_data/original_permeability_regression_dataset2.xlsx'  # Please ensure the data path is correct
    data_file = 'processed_results.xlsx'  # Please ensure the data path is correct
    ...
    for fold, (train_idx, val_idx) in enumerate(kf.split(X)):
        ...
        plot_loss_curves(history, 'LSTM', fold + 1, output_dir)

        # Plot and save MAE curve
        plot_metric_curve(history, 'mae', 'LSTM', fold + 1, output_dir)

        # Plot and save R2 curve
        plot_metric_curve(history, 'r2', 'LSTM', fold + 1, output_dir)
    ...
    csv_path = os.path.join(output_dir, 'LSTM_Results.csv')
